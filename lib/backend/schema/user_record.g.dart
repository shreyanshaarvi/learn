    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'is_admin':
          ...
          break;
        case 'imageRefrence':
          result.imageRefrence = serializers.deserialize(value,
...
class _$UserRecord extends UserRecord {
  ...
  final bool? isAdmin;
  @override
  final DocumentReference<Object?>? imageRefrence;
  @override
  ...
  bool operator ==(Object other) {
    ...
    return other is UserRecord &&
        ...
        imageRefrence == other.imageRefrence &&
        ffRef == other.ffRef;
  }
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'UserRecord')
          ...
          ..add('isAdmin', isAdmin)
          ..add('imageRefrence', imageRefrence)
          ..add('ffRef', ffRef))
        .toString();
  }
}
...
class UserRecordBuilder implements Builder<UserRecord, UserRecordBuilder> {
  ...
  DocumentReference<Object?>? _imageRefrence;
  DocumentReference<Object?>? get imageRefrence => _$this._imageRefrence;
  set imageRefrence(DocumentReference<Object?>? imageRefrence) =>
      _$this._imageRefrence = imageRefrence;
  ...
  UserRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _isAdmin = $v.isAdmin;
      _imageRefrence = $v.imageRefrence;
      _ffRef = $v.ffRef;
      _$v = null;
    }
    return this;
